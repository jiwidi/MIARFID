...
def load_parameters():
    ...
    DATA_ROOT_PATH = "%s/Data/%s/sinlower" % (
        TA,
        DATASET_NAME,
    )  # Path where data is stored.

    # SRC_LAN or TRG_LAN will be added to the file names.
    TEXT_FILES = {"train": "tr-full.", "val": "dev.", "test": "test."}  # Data files.
    ...
    LR = 0.0005  # Learning rate. Recommended values - Adam 0.0002 - Adadelta 1.0.
