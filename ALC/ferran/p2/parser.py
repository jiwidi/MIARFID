...
files = [
    "data/TASS2017_T1_test.xml",
    "data/TASS2017_T1_training.xml",
    "data/TASS2017_T1_development.xml",
]
    ...
    for t in tweets:
        for node in t.childNodes:
            ...
            if file != "data/TASS2017_T1_test.xml":
                ...
                target.append(None)
    df = pd.DataFrame(list(zip(ids, texts, target)), columns=["id", "text", "target"])
