...
if __name__=='__main__':
    ...
    modelo_en = GradientBoostingClassifier(loss='deviance', learning_rate=0.01, n_estimators=250, verbose=1)
    scores_en = cross_val_score(modelo_en, matriz_train_es.toarray(), Y_train_es, cv=10, scoring='accuracy')
