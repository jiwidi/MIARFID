# Autores:  Jaime Ferrando Huertas
...
class MyFleetManagerStrategy(FleetManagerStrategyBehaviour):
    # El manager maneja una lista de tuplas donde almacenará el id y la posición de
    # los agentes de tipo transporte. Cuando le llegue una petición de un cliente, 
    # buscará en la lista el transporte más cercano al cliente y le enviará la petición.
        ...
        if msg:
            ...
            if performative == PROPOSE_PERFORMATIVE:
                ...
                if len(posiciones) > 0:
                    ...
                    msg.to = cercano[0] # Enviamos la solicitud del cliente al transporte más cercano
...
class MyTransportStrategy(TransportStrategyBehaviour):
    ...
    async def run(self):
        # Hay que actualizar la posicion en el manager cuando el transporte está libre (cuando no se está moviendo)
        # Enviamos una propuesta al manager con la posición actual del transporte
