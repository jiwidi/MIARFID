...
# train models
scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/right-0.10 -p DATA/Tr-right-extended -n DATA/Tr-right-neg -H 0.1 -i 1
scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/equil-0.10 -p DATA/Tr-equil-extended -n DATA/Tr-equil-neg -H 0.1 -i 1
scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/isosc-0.10 -p DATA/Tr-isosc-extended -n DATA/Tr-isosc-neg -H 0.1 -i 1
