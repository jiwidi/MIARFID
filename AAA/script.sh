...
for ratio in {0.01,0.05,0.1,0.2,0.3}
  do
    ...
    # train models
    scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/right-0.10 -p DATA/Tr-right -n DATA/Tr-right-neg -H ratio -i 1 > /dev/null 2>&1
    scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/equil-0.10 -p DATA/Tr-equil -n DATA/Tr-equil-neg -H ratio -i 1 > /dev/null 2>&1
    scfg-toolkit/scfg_learn_mmi -g MODELS/G-1 -f MODELS/isosc-0.10 -p DATA/Tr-isosc -n DATA/Tr-isosc-neg -H ratio -i 1 > /dev/null 2>&1
