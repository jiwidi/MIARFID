...
(define (problem probtransporte)
    ...
    (:init
        ...
        ;Aviones
        (= (combustible Av1) 100000)
        (= (combustible Av2) 100000)
        ;Trenes
        (= (combustible T1) 50000)
        (= (combustible T2) 50000)
        ;Furgonetas
        (= (combustible F1) 10000)
        (= (combustible F2) 10000)
        (= (combustible F3) 10000)
        (= (combustible F4) 10000)

        ;Capacidad
        (= (capacidad Av1) 100000)
        (= (capacidad Av2) 100000)
        (= (capacidad T1) 50000)
        (= (capacidad T2) 50000)
        (= (capacidad F1) 10000)
        (= (capacidad F2) 10000)
